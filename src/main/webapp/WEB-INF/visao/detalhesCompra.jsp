...
<nav class="fixed-top">
	...
	<div class="container">
		...
		<br><br><br><br>
			<c:choose>
				<c:when test="${compra != null}">
					<h1 style="text-align: center;">Detalhes da Compra de código "${compra.cod}":</h1>
					<table class="table table-hover" style="margin: auto; width: 40%;">
						<tr>
							<th style="text-align: right;">Código:</th>
							<td style="text-align: left;">${compra.cod}</td>
						</tr>
						<tr>
							<th style="text-align: right;">Forma de Pagamento:</th>
							<td style="text-align: left;">${compra.formaPagamento}</td>
						</tr>
						<tr>
							<th style="text-align: right;">Avaliação:</th>
							<td style="text-align: left;">${compra.avaliacao}</td>
						</tr>
						<tr>
							<th style="text-align: right;">Comentário:</th>
							<td style="text-align: left;">${compra.comentario}</td>
						</tr>
						<tr>
							<th style="text-align: right;">Data/Hora:</th>
							<td style="text-align: left;">${compra.dataHora.time}</td>
						</tr>
						<tr>
							<th style="text-align: right;">Produtos:</th>
							<c:forEach var="prod" items="${compra.produtosC}">
					...
					<a href="controladorCompra?acao=gerenciarCompras"><button id="botCad" style="float: right; background-color: #FF7804; border-color: #CC5F02; font-weight: bold;" class="btn btn-primary mb-2" >Voltar ao Gerenciamento de Compras <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button></a>
				</c:when>
				<c:otherwise>
					<h3 style="text-align: center; color: red;">Esta compra não está cadastrada!</h3><br>
					<div style="width: 50%; margin: auto; display: flex; justify-content: center;">
						<a href="controladorCompra?acao=gerenciarCompras"><button id="botCad" style="background-color: #FF7804; border-color: #CC5F02; font-weight: bold;" class="btn btn-primary mb-2" >Voltar ao Gerenciamento de Compras <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button></a>
					</div>
				</c:otherwise>
			</c:choose>
		</div>
