				...
				<div style="width: 50%;">
					<ul class="list-group" style="margin: 0; background-color: white; max-width: 100%; text-align: left; border-color: #CC5F02">
						...
						<li class="list-group-item"
							...
							${online.sexo}</li>
						<li class="list-group-item"
							style="margin: 0; width: auto; border-color: #CC5F02"><b>CÓDIGO:</b><br>
							${online.cod}</li>
						<li class="list-group-item"
				...
				<div style="width: 50%;">
					<ul class="list-group" style="margin: 0; background-color: white; max-width: 100%; text-align: center; border-color: #CC5F02">
						<li class="list-group-item" style="margin: 0; width: auto; border-color: #CC5F02">
							<b>PRODUTOS CADASTRADOS:</b> ${qtdProd}
							<a href="controladorP?acao=gerenciarProdutos" style="padding: 0" class="a1"><button id="botCad" style="min-width: 100%; min-height: 100%;margin: 0!important;background-color: #FFFFB3; border-color: #CC5F02; color: black; font-weight: bold; height: 100%" class="btn btn-primary mb-2">
								Gerenciar Produtos
							</button></a>
						</li>
						<li class="list-group-item" style="margin: 0; width: auto; border-color: #CC5F02">
							<b>CLIENTES CADASTRADOS:</b> ${qtdCli}
							<a href="controladorC?acao=gerenciarClientes" style="padding: 0" class="a1"><button id="botCad" style="min-width: 100%; min-height: 100%;margin: 0!important;background-color: #FFFFB3; border-color: #CC5F02; color: black; font-weight: bold; height: 100%" class="btn btn-primary mb-2">
								Gerenciar Clientes
							</button></a>
						</li>
					</ul>
