		...
		<div style="margin: auto; width: 75%;">
			<form style="margin: auto; width: 100%;" action="controladorP?acao=cadastrarProduto" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<textarea style="resize: none;" rows="10" cols="30" required="required" class="form-control" id="descricaoProduto" name="descricaoProduto" maxlength="680" placeholder="Descrição do Produto..."></textarea>
				</div>
