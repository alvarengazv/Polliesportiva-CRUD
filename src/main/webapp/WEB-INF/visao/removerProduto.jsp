		...
		<div style="margin: auto; width: 75%; text-align: center;">
			<c:choose>
				<c:when test="${Produto != null}">
					<h1 style="text-align: center; color: #6fdb02;">O Produto ${Produto.cod} foi Removido com Sucesso!</h1>
					...
					<a href="controladorP?acao=gerenciarProdutos"><button id="botCad" style="float: right; background-color: #FF7804; border-color: #CC5F02; font-weight: bold;" class="btn btn-primary mb-2" >Voltar ao Gerenciamento de Produtos <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button></a>
				</c:when>
				<c:otherwise>
