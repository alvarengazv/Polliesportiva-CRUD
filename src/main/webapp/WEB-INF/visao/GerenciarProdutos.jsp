...
<div style="margin: auto; display: flex; justify-content:space-between; max-width: 80%; padding-top: 2.5%;padding-bottom: 2.5%;">
	<div class="container" style="max-width: 92%;">
		<div style="margin: auto; width: 100%; text-align: center;">
			<h1 style="text-align: center;"> Gerenciamento de Produtos </h1><br><br>
						...
						<c:forEach var="produto" items="${Produtos}">
							<tr>
								...
								<td style="justify-content:space-between;">
									<a href="controladorP?acao=detalhesProduto&cod=${produto.cod}"><button id="botCad" style="float: left;background-color: #8F8; border-color:  #CC5F02; color: black; font-weight: bold; height: 100%" class="btn btn-primary mb-2">Detalhes <i class="fa fa-search-plus"></i></button></a>
									<a href="controladorP?acao=formAtualizarProduto&cod=${produto.cod}"><button id="botCad" style="margin: auto;background-color: #FFFFB3; border-color:  #CC5F02; color: black; font-weight: bold; height: 100%" class="btn btn-primary mb-2">Atualizar <i class="fa fa-undo" aria-hidden="true"></i></button></a>
									<a href="controladorP?acao=removerProduto&cod=${produto.cod}"><button id="botCad" class="btn btn-primary mb-2" style="float: right;background-color: #F88; border-color: #CC5F02; color: black; font-weight: bold; height: 100%">Remover <i class="fa fa-trash"></i></button></a>
								</td>
							</tr>
						</c:forEach>
						</tbody>
					</table><br>
					<a href="controladorP?acao=formCadastrarProduto"><button id="botCad" style="float: right; background-color: #FF7804; border-color: #CC5F02; font-weight: bold;" class="btn btn-primary mb-2" >Cadastrar Produto <i class="fa fa-plus-circle" aria-hidden="true"></i></button></a>
				</c:when>
				<c:otherwise>
					<h3 style="text-align: center; color: red;">Não há Produtos Cadastrados!</h3><br><br>
					<div style="width: 50%; margin: auto; display: flex; justify-content: center;">
						<a href="controladorP?acao=formCadastrarProduto"><button id="botCad" style="background-color: #FF7804; border-color: #CC5F02; font-weight: bold;" class="btn btn-primary mb-2" >Cadastrar Produto <i class="fa fa-plus-circle" aria-hidden="true"></i></button></a>
					</div>
				</c:otherwise>
			</c:choose>
		</div>
