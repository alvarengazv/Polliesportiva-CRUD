...
<nav class="fixed-top">
	...
	<div class="container">
		...
		<br><br><br><br>
		<c:if test="${msg != null}"><h3 style="text-align: center; color: red">${msg}</h3></c:if>
			
		<div style="margin: auto;background-color: #faebde; border: 1px solid #CC5F02; border-radius: 30px; max-width:30%; padding: 60px 0px 40px 0px">
			<h4 style="text-align: center;"> Entre ou Cadastre-se! </h4><br>
			<div style="margin: auto; width: 80%;">
				<form style="margin: auto; width: 80%;" action="controlador?acao=loginUsuario" method="post">
					
					<div class="form-group">
						<label for="loginU"> Login: </label>
						<input required="required" class="form-control" type="text" id="loginU" name="loginU" placeholder="Login...">
					</div>
					<div class="form-group">
						<label for="senhaU"> Senha: </label>
						<input required="required" class="form-control" type="password" id="senhaU" name="senhaU" placeholder="Senha...">
					</div>
					<button id="botCad" style="width: 100%; background-color: #FF7804; border-color: #CC5F02;" type="submit" class="btn btn-primary mb-2" >Entrar</button>
				</form>
				<br><a href="controladorC?acao=formCadastrarCliente"><button id="botCad" style="width: 100%; background-color: #8F8; border-color:  #CC5F02;" class="btn btn-primary mb-2" >Cadastre-se</button></a>
			</div>
		</div>
	</div>
