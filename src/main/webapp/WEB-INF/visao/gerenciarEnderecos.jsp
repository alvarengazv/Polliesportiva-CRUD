...
<div style="margin: auto; display: flex; justify-content:space-between; max-width: 90%; padding-top: 2.5%;padding-bottom: 2.5%;">
	<div class="container" style="max-width: 98%;">
		...
		<h1 style="text-align: center;"> Gerenciamento de Endereços </h1><br>
						...
						<c:forEach var="endereco" items="${enderecos}">
							<tr>
								...
								<td style="justify-content:space-around;">
									<a href="controladorE?acao=formAtualizarEndereco&cod=${endereco.cod}&codCli=${codCli}"><button id="botCad" style="float: left;margin: auto;background-color: #FFFFB3; border-color:  #CC5F02; color: black; font-weight: bold; height: 100%" class="btn btn-primary mb-2">Atualizar <i class="fa fa-undo" aria-hidden="true"></i></button></a>
									<a href="controladorE?acao=removerEndereco&cod=${endereco.cod}&codCli=${codCli}"><button id="botCad" class="btn btn-primary mb-2" style="float: right;background-color: #F88; border-color: #CC5F02; color: black; font-weight: bold; height: 100%">Remover <i class="fa fa-trash"></i></button></a>
								</td>
							</tr>
						</c:forEach>
						</tbody>
					</table><br>
					<a href="controladorE?acao=formCadastrarEndereco&codCli=${codCli}"><button id="botCad" style="float: right; background-color: #FF7804; border-color: #CC5F02; font-weight: bold;" class="btn btn-primary mb-2" >Cadastrar Endereço <i class="fa fa-plus-circle" aria-hidden="true"></i></button></a>
				</c:when>
				<c:otherwise>
					<h3 style="text-align: center; color: red;">Não há Endereços Cadastrados!</h3><br><br>
					<div style="width: 50%; margin: auto; display: flex; justify-content: center;">
						<a href="controladorE?acao=formCadastrarEndereco&codCli=${codCli}"><button id="botCad" style="background-color: #FF7804; border-color: #CC5F02; font-weight: bold;" class="btn btn-primary mb-2" >Cadastrar Endereço <i class="fa fa-plus-circle" aria-hidden="true"></i></button></a>
					</div>
				</c:otherwise>
			</c:choose>	
