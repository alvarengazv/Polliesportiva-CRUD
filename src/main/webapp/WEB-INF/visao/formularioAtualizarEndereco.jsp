	...
	<div style="margin: auto; width: 75%;">
			<c:choose>
				<c:when test="${endereco != null}">
					<h3 style="text-align: center;"> Atualização do Endereco "${endereco.nomeEnd}":</h3><br>
					<form style="margin: auto; width: 60%;" action="controladorE?acao=atualizarEndereco&cod=${endereco.cod}&codCli=${codCli}" method="post">
						<div class="form-group">
							<label for="nomeEndereco"> Nome do endereço: </label>
							<input required="required" class="form-control" type="text" id="nomeEndereco" name="nomeEndereco" value="${endereco.nomeEnd}">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input required="required" class="form-control" type="text" id="cidadeEndereco" name="cidadeEndereco" value="${endereco.cidade}">
						</div>
						<div class="form-group">
							<label for="bairroEndereco"> Bairro: </label>
							<input required="required" class="form-control" type="text" id="bairroEndereco" name="bairroEndereco" value="${endereco.bairro}">
						</div>
						<div class="form-group">
							<label for="cepEndereco"> CEP: </label>
							<input required="required" class="form-control" type="text" id="cepEndereco" name="cepEndereco" value="${endereco.cep}" pattern="[0-9]{2}.[0-9]{3}-[0-9]{3}">
						</div>
						<div class="form-group">
							<label for="ruaEndereco"> Rua/Avenida: </label>
							<input required="required" class="form-control" type="text" id="ruaEndereco" name="ruaEndereco" value="${endereco.rua}">
						</div>
						<div class="form-group">
							<label for="numeroEndereco"> Número: </label>
							<input required="required" class="form-control" type="number" style="-moz-appearance: textfield;" id="numeroEndereco" name="numeroEndereco" value="${endereco.numero}" min="1">
						</div>
						<div class="form-group">
							<label for="complementoEndereco"> Complemento: </label>
							<input class="form-control" type="text" id="complementoEndereco" name="complementoEndereco"  value="${endereco.complemento}">
						</div>
						<div class="form-group">
							<label for="referenciaEndereco"> Referência: </label>
							<input class="form-control" type="text" id="referenciaEndereco" name="referenciaEndereco" value="${endereco.referencia}">
						</div>
						<button id="botCad" style="float: right; background-color: #FF7804; border-color: #CC5F02;" type="submit" class="btn btn-primary mb-2" >Atualizar Endereço</button>
					</form>
				</c:when>
				<c:otherwise>
					<h3 style="text-align: center; color: red;">Este endereço não está cadastrado!</h3><br>
					<div style="width: 50%; margin: auto; display: flex; justify-content: center;">
						<a href="controladorE?acao=gerenciarEnderecos"><button id="botCad" style="background-color: #FF7804; border-color: #CC5F02; font-weight: bold;" class="btn btn-primary mb-2" >Voltar ao Gerenciamento de Endereços <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button></a>
					</div>
				</c:otherwise>
			</c:choose>
		</div>
